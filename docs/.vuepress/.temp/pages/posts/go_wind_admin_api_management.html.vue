<template><div><h1 id="gowind-admin-风行-—-开箱即用的企业级全栈中后台框架-api管理" tabindex="-1"><a class="header-anchor" href="#gowind-admin-风行-—-开箱即用的企业级全栈中后台框架-api管理"><span>GoWind Admin｜风行 — 开箱即用的企业级全栈中后台框架：API管理</span></a></h1>
<p>开门见山，<a href="https://go-kratos.dev/" target="_blank" rel="noopener noreferrer">Kratos</a>内置的RPC是<a href="https://grpc.io/" target="_blank" rel="noopener noreferrer">gRPC</a>，而gRPC是基于<a href="https://protobuf.dev/" target="_blank" rel="noopener noreferrer">Protobuf</a>作为 <strong>接口规范的描述语言（IDL，Interface Description Language）</strong>。</p>
<p>与此同时我们还可以通过<a href="https://github.com/grpc-ecosystem/grpc-gateway" target="_blank" rel="noopener noreferrer">grpc-gateway</a>对RESTfull进行支持。这样，Kratos就同时支持gRPC和REST。</p>
<p>也就是说，我们只需要编写一套Protobuf代码，就能够同时支持 <strong>gRPC协议</strong> 和 <strong>RESTfull协议</strong>。</p>
<p>Protobuf支持很多编程语言，比如：C++、Java、JavaScript、Python、Go、Ruby、Objective-C、C#……这也就意味着，它很适合多语言异构化架构，这样的场景在现实应用当中是很稀松平常的，这使得Protobuf具有很强的实用性。</p>
...
<p>了解了基础的知识之后，我们简单的了解一下本文的核心知识点：</p>
<ol>
<li>使用<a href="https://protobuf.dev/" target="_blank" rel="noopener noreferrer">Protobuf</a>编写API；</li>
<li>使用<a href="https://buf.build/" target="_blank" rel="noopener noreferrer">Buf</a>管理proto；</li>
<li>使用<a href="https://www.gnu.org/software/make/" target="_blank" rel="noopener noreferrer">Make</a>执行Buf命令。</li>
</ol>
<h2 id="_1-使用protobuf编写api" tabindex="-1"><a class="header-anchor" href="#_1-使用protobuf编写api"><span>1. 使用Protobuf编写API</span></a></h2>
<div class="language-proto line-numbers-mode" data-highlighter="prismjs" data-ext="proto"><pre v-pre><code><span class="line">syntax = &quot;proto3&quot;;</span>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>以上是<code v-pre>用户User</code>的一个完整的gRPC的API，包含了最基本的：用户数据结构，CURD的API。</p>
<p>需要特别讲解的是：<code v-pre>gnostic.openapi.v3.property</code>，这是用于生成OpenAPI的。</p>
<p>下面再给出RESTFull的服务定义：</p>
<div class="language-proto line-numbers-mode" data-highlighter="prismjs" data-ext="proto"><pre v-pre><code><span class="line">syntax = &quot;proto3&quot;;</span>
<span class="line"></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><blockquote>
<p>这里需要说明的是：两个<code v-pre>UserService</code>可以是合二为一，也可以有多个。初学者一定会疑惑，我为什么要将之分离开来，为啥不能一个？首先，它可以只有一个，即RESTfull和gRPC的接口定义都在一个<code v-pre>UserService</code>当中，而我分离开来了，那么，我为什么分离开来了呢？分离开来的好处是，职责分明。前者用于内部通讯的RPC接口，后者用于对外的RESTfull接口。</p>
</blockquote>
<p>在实际应用中，我们可能有admin和面向于app的两套API，我们就可以分别对之进行定义：</p>
<div class="language-proto line-numbers-mode" data-highlighter="prismjs" data-ext="proto"><pre v-pre><code><span class="line">syntax = &quot;proto3&quot;;</span>
<span class="line"></span>
...
<span class="line">}</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_2-使用buf管理proto" tabindex="-1"><a class="header-anchor" href="#_2-使用buf管理proto"><span>2. 使用Buf管理proto</span></a></h2>
<p>当我们用熟悉了Protobuf之后，会遇到一个很头疼的问题：</p>
<p>我们该如何去管理和构建它呢？</p>
<p>在最早的时候，我只能够手动的调用protoc命令进行代码生成：</p>
<div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre v-pre><code><span class="line"><span class="token comment"># generate go struct code</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>怎么样，头大不？要调用这么多命令，生成这么多代码。我后来又想了很多办法，比如：</p>
<ol>
<li>写进Shell脚本；</li>
<li>写进Makefile；</li>
<li>利用go语言的go:generate注解。</li>
</ol>
<p>结果发现，全部都不实用，而且无法进行工程化，在团队内难以实施。直到最后，我发现了<a href="https://docs.buf.build/" target="_blank" rel="noopener noreferrer">buf.build</a>这个专门用于构建protobuf API的工具。</p>
<p>Buf主要提供了两个工具：</p>
<ol>
<li><strong>Buf Schema Registry（BSR）：</strong> 其官方网站地址：<a href="https://buf.build/" target="_blank" rel="noopener noreferrer">buf.build</a>，是一个用于管理和共享 Protocol Buffers（protobuf）代码的平台。</li>
<li><strong>Buf CLI：</strong> 是一个强大的命令行工具，提供了一系列用于处理、验证和管理 protobuf 代码的功能。</li>
</ol>
<p>简单的说就是：BSR是一个proto的代码库，类似于github，上面我用到的 <a href="https://buf.build/tx7do/pagination" target="_blank" rel="noopener noreferrer">pagination.proto</a>，我就是提交到了BSR。</p>
<p>更多时候，我们使用最多的是Buf CLI这个工具，用它来生成代码，用的最多的就是两个命令：</p>
<ol>
<li><code v-pre>buf dep update</code> 用于更新三方依赖proto；</li>
<li><code v-pre>buf generate</code> 用于生成代码。</li>
</ol>
<p>buf有两套配置文件：</p>
<ol>
<li>
<p><code v-pre>buf.yaml</code> 主要也就是定义proto文件的路径，以及依赖的第三方proto。</p>
<div class="language-yaml line-numbers-mode" data-highlighter="prismjs" data-ext="yml"><pre v-pre><code><span class="line"><span class="token key atrule">version</span><span class="token punctuation">:</span> v2</span>
<span class="line"></span>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li>
<li>
<p><code v-pre>buf.gen.yaml</code> 定义生成规则（这里是go代码生成）。</p>
...
<p>如果我们还需要生成OpenAPI，则可以再多定义个比如文件名为<code v-pre>buf.openapi.gen.yaml</code>的proto文件：</p>
<div class="language-yaml line-numbers-mode" data-highlighter="prismjs" data-ext="yml"><pre v-pre><code><span class="line"><span class="token comment"># 配置protoc生成规则</span></span>
<span class="line"><span class="token key atrule">version</span><span class="token punctuation">:</span> v2</span>
<span class="line"></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>执行命令：<code v-pre>buf generate --template buf.openapi.gen.yaml</code>生成OpenAPI文档。</p>
<p>要生成Typescript代码就创建一个<code v-pre>buf.typescript.gen.yaml</code>的配置文件：</p>
<div class="language-yaml line-numbers-mode" data-highlighter="prismjs" data-ext="yml"><pre v-pre><code><span class="line"><span class="token comment"># 配置protoc生成规则</span></span>
<span class="line"><span class="token key atrule">version</span><span class="token punctuation">:</span> v2</span>
<span class="line"></span>
<span class="line"><span class="token key atrule">clean</span><span class="token punctuation">:</span> <span class="token boolean important">true</span></span>
...
<span class="line">      <span class="token punctuation">-</span> paths=source_relative <span class="token comment"># 使用相对路径</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>执行命令：<code v-pre>buf generate --template buf.typescript.gen.yaml</code>生成TypeScript代码。</p>
<blockquote>
<p>需要注意的是，protoc的插件可以用本地的插件，也可以用远端BSR中的protoc插件。在上面的实例里面，我都用的是本地的protoc插件，需要先行在本地进行安装。在团队协作当中，建议使用远端的protoc插件，用远端的protoc插件有个好处，那就是可以保证每一个人所使用的插件一致性（本地的有可能版本不一致）。</p>
</blockquote>
<h2 id="_3-使用make执行buf命令" tabindex="-1"><a class="header-anchor" href="#_3-使用make执行buf命令"><span>3. 使用Make执行Buf命令</span></a></h2>
<p>本以为用了Buf之后，可以高枕无忧了，实际运用中，我们有可能会有多个buf的生成配置文件，那么我们就需要多个生成命令。命令写进shell脚本也不是不可以，但是，会有平台差异（Windows没有shell脚本，只有bat）。那么，我们可以使用Makefile，make是可以在任意平台上运行的，包括Windows。</p>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><blockquote>
<p><code v-pre>buf generate</code>命令默认读取的是当前目录下文件名为<code v-pre>buf.gen.yaml</code>的配置文件。</p>
</blockquote>
<p>现在我们就可以在项目的根目录下面运行make命令：</p>
<p>生成go代码:</p>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><p>生成OpenAPI文档：</p>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><p>生成TypeScript代码：</p>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><p>生成Dart代码：</p>
<div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre v-pre><code><span class="line"><span class="token function">make</span> dart</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><h2 id="项目代码" tabindex="-1"><a class="header-anchor" href="#项目代码"><span>项目代码</span></a></h2>
<ul>
