<template><div><h1 id="protobuf生成golang代码的4种方法" tabindex="-1"><a class="header-anchor" href="#protobuf生成golang代码的4种方法"><span>Protobuf生成golang代码的4种方法</span></a></h1>
...
<h2 id="插件生成文件一览表" tabindex="-1"><a class="header-anchor" href="#插件生成文件一览表"><span>插件生成文件一览表</span></a></h2>
<table>
<thead>
<tr>
<th>插件名</th>
...
<h2 id="_4种方法" tabindex="-1"><a class="header-anchor" href="#_4种方法"><span>4种方法</span></a></h2>
<ol>
...
<span class="line">  <span class="token punctuation">-</span> third_party</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="buf-gen-yaml" tabindex="-1"><a class="header-anchor" href="#buf-gen-yaml"><span>buf.gen.yaml</span></a></h4>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>没错，它是为了生成<a href="https://openapi.apifox.cn/" target="_blank" rel="noopener noreferrer">OpenAPI v3文档</a>。我之前尝试了放在根目录下的<code v-pre>buf.gen.yaml</code>，但是产生了错误，因为OpenAPI v3文档，它全局只能产生一个<code v-pre>openapi.yaml</code>文件。所以，没辙，只能单独对待了。</p>
